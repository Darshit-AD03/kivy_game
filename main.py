...
class MainWidget(RelativeLayout):
    ...
    menu_title = StringProperty("G A M E   1")
    ...
    def init_audio(self):
        ...
        self.sound_name = SoundLoader.load("audio/synthesize.wav")
        self.sound_gameover_impact = SoundLoader.load("audio/impact.wav")
        self.sound_gameover_voice = SoundLoader.load("audio/voice.wav")
        self.sound_music1 = SoundLoader.load("audio/lse.wav")
        self.sound_restart = SoundLoader.load("audio/restart.wav")

        self.sound_music1.volume = 1
        self.sound_begin.volume = .25
        self.sound_name.volume = .25
